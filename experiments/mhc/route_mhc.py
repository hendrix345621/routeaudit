...
already-derived suffix, e.g. one transferred from a sibling model.
    ...
    python experiments/mhc/route_mhc.py --config deepseek-v4-flash
    python experiments/mhc/route_mhc.py --config deepseek-v2-lite \
...
_DEFAULT_CONFIG = "deepseek-v4-flash"
