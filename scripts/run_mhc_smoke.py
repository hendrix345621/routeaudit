...
def main() -> None:
    ...
    ap.add_argument("--config", default="deepseek-v4-flash")
    ...
    try:
        ...
        commands = [
            (
                "synthetic_level_0",
                [sys.executable, "experiments/mhc/tests/run_synthetic.py"],
            ),
            (
                "real_fixture_extract",
                [
                    sys.executable,
                    "experiments/mhc/fixtures/extract.py",
                    "--config",
                    args.config,
                    "--out",
                    str(fixture_path),
            ...
            (
                ...
                [
                    sys.executable,
                    "experiments/mhc/fixtures/validate.py",
                    "--fixtures",
                    str(fixture_path),
                    "--atol",
                    "2e-7",
